...
## Unlocking Secure Browsing with Less Cost: Exploring the Features of Private Internet Access as an Elite, Open-Source VPN by ZDNET

[![private-internet-access-review.jpg](https://www.zdnet.com/a/img/2021/08/12/7645c9f8-3ffb-4845-9fcb-2a8794a1eaf3/private-internet-access-review.jpg) Private Internet Access 4 / 5  Very good](https://www.dpbolvw.net/click-9041660-14570828-1657804763000?sid=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) 
...
* App can be sluggish
* Antivirus is an upsell
* Some won't like US-based

[View now at Private Internet Access](https://www.dpbolvw.net/click-9041660-14570828-1657804763000?sid=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp)

Private Internet Access is a powerful, flexible [VPN](https://www.zdnet.com/article/what-is-a-vpn-and-how-does-it-work/) that does a good job of keeping your data and location safe. And that's fine. But can I tell you what I think is the standout feature of Private Internet Access (beyond the fact that it abbreviates amusingly to P.I.A.)? It's that you can download the complete source code from Github. Just [click here](https://github.com/pia-foss) and you can see what makes Private Internet Access tick. 
...
**Also:** [**The top 5 fastest VPNs**](https://www.zdnet.com/article/fastest-vpn/)

Private Internet Access is also US-based. There's a lot of fuss in the VPN community about companies subject to government oversight, and competitors like [Proton VPN](https://www.zdnet.com/article/proton-vpn-review/) even call the US "a high-risk nation." I like how Private Internet Access reframes that premise: 
...
| **Spec**                     | **Private Internet Access**         |
| ---------------------------- | ----------------------------------- |
| **Servers**                  | ??                                  |
| **Countries**                | 84                                  |
| **Simultaneous connections** | 10                                  |
| **Ad blocker**               | add-on                              |
| **Malware scanner**          | add-on                              |
| **Kill switch**              | yes                                 |
| **Logging**                  | no                                  |
| **Split-tunneling**          | yes                                 |
| **Best price**               | $79 for 39 months ($2.09/month)     |
...
| **Months purchased**       | 1      | 12    | 39    |
| -------------------------- | ------ | ----- | ----- |
| **What you pay**           | $11.95 | $40   | $79   |
| **Equivalent monthly fee** | $11.95 | $3.33 | $2.03 |
...
| **Months purchased**       | 1     | 12    | 36  |
| -------------------------- | ----- | ----- | --- |
| **What you pay**           | $4.50 | $24   | $36 |
| **Equivalent monthly fee** | $4.50 | $2.00 | $1  |
...
| **Months purchased**       | 1     | 12    | 36    |
| -------------------------- | ----- | ----- | ----- |
| **What you pay**           | $5.00 | $51   | $90   |
| **Equivalent monthly fee** | $5.00 | $4.25 | $2.50 |
...
I used [dnsleak.com](https://dnsleak.com/), [dnsleaktest.com](https://dnsleaktest.com/), [ipleak.net](https://ipleak.net/), and [browserleaks.com](http://browserleaks.com/) for my testing process. Here are the results: 
...
**Also:** [**The best VPNs for torrenting**](https://www.zdnet.com/article/best-torrenting-vpn/)
...
I can't independently verify the first question, but Private Internet Access says it doesn't log any data. That question is probably the hardest to answer definitively because few of the VPN vendors we've looked at have independent audits to verify their claims, but Private Internet Access is one who does. They recently conducted an audit with Big Four accounting firm Deloitte. You can read the results of that audit [here](https://www.privateinternetaccess.com/blog/privacy-audit/).
