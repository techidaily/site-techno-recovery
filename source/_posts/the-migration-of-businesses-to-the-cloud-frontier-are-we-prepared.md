---
title: "The Migration of Businesses to the Cloud Frontier: Are We Prepared?"
date: 2024-09-18 10:38:59
updated: 2024-09-20 10:11:42
tags:
  - edge-computing
categories:
  - tech
...
## The Migration of Businesses to the Cloud Frontier: Are We Prepared?

![Cloud computing concept](https://www.zdnet.com/a/img/resize/8da344aab8253e9404e247c393fe71da53a12a27/2023/05/10/51666f9e-d629-4181-88d9-49fc629b37b1/gettyimages-1484912807.jpg?auto=webp&width=1280)
...
It's a big deal. An average of 35% of US computing resources now reside at the edge, according to estimates by IDG/Foundry, in a [survey](https://www.insight.com/content/dam/insight-web/en%5FUS/pdfs/insight/the-path-to-digital-transformation--where-leaders-stand-in-2023.pdf) commissioned by Insight Enterprises and [reported](https://www.techrepublic.com/article/it-leaders-edge-computing-survey/) by Megan Crouse in TechRepublic. In addition, 36% listed the need to process data from edge devices as a top objective, an increase from 27% the year before. There's low latency in localized data processing, as well as the security of not having data in motion. 
...
Industry observers agree that [edge systems](https://www.zdnet.com/topic/understanding-edge-computing/) will increasingly do the bulk of information technology work. "Machine learning and aggregation-type computations are being deployed more and more at the edge," says [Rob Mesirow](https://www.linkedin.com/in/robmesirow/), partner and connected solutions/IoT leader for PwC. "The key idea is to reduce the size and the number of events that have to be sent to the cloud. Computations that can be performed in a streaming fashion on a bounded number of data streams can be easily shifted to the edge."

Real-time response time "is hard to achieve at scale with a single centralized cloud computing cluster," says [Jeff Fried](https://www.intersystems.com/contact/jeff-fried/), director of product management at InterSystems. "Similarly, real-time and near-real time analytics are achievable, and real-time insight is very popular, once you realize you can achieve it." 

The push to the edge is a trend that will not let up anytime soon. "As networks are built out, the window to introduce the next great technologies and capabilities will open wider and wider," says [Adam Compton](https://www.linkedin.com/in/sneakattack/), director of strategy at Schneider Electric. "These capabilities will have a profound impact on us all, but will require tremendous, localized computing capabilities to ensure latency is almost nonexistent." 
