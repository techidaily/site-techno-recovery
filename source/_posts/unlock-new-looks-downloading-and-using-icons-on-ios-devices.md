...
date: 2024-08-18T17:28:03.928Z
updated: 2024-08-19T17:28:03.928Z
categories:
  - BestProducts
description: "This Article Describes Unlock New Looks: Downloading and Using Icons on iOS Devices"
excerpt: "This Article Describes Unlock New Looks: Downloading and Using Icons on iOS Devices"
...
1. Download, install, and open iFont.
2. From the main page of the app, tap**Find Fonts to Install** .
...
7. iFont asks for permission to download the file. Select**Allow** to continue.
8. You’ll be notified when the download has finished and then see a pop-up screen explaining how to complete the installation.
...
14. Download, install, and open Fonteer.
15. From the main page of the app, tap**+** to create a new collection.
...
29. Find a font you’re interested in and select it.
30. You can scroll through the various versions of the typeface (light, regular, bold, etc).  
![Google Fonts in Safari with Josefin Sans highlighted and font styles listed](https://www.lifewire.com/thmb/WIH0Z6qxD34T0V9yEePVENn8_iw=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/googlefonts-69fe6a00f6fa4645a55a989314fd40a5.jpg)
31. Tap**Select this style** .
32. From the menu that pops up, tap**Download all** .
...
46. Open the iPhone’s**Settings** . Scroll down and tap**General** .
47. Scroll down and tap**Profiles** .
...
* How do I change font size on iPhone?  
    To[change the font size on an iPhone](https://www.lifewire.com/how-to-view-text-with-larger-type-in-ios-mail-1172540) , go to**Settings** \>**Display & Brightness** \>**Text Size** . Drag the slider to the right to increase text size, or move it left to decrease the text size. You'll see the sample text change as you adjust the size. To make the text even bigger, go to**Settings** \>**Accessibility** \>**Larger Text** and toggle on**Larger Accessibility Sizes** .  
* How do I change font color on an iPhone?  
    You can add color filters to help you differentiate between colors on your iPhone. Go to**Settings** \> **Accessibility** \>**Display & Text Size** and tap**Color Filters** . Toggle on**Color Filters** and choose from the available options.
