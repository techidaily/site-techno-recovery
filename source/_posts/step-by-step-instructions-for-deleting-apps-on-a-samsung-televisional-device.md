---
title: Step-by-Step Instructions for Deleting Apps on a Samsung Televisional Device
date: 2024-08-18T17:43:17.543Z
updated: 2024-08-19T17:43:17.543Z
categories:
  - BestProducts
description: This Article Describes Step-by-Step Instructions for Deleting Apps on a Samsung Televisional Device
excerpt: This Article Describes Step-by-Step Instructions for Deleting Apps on a Samsung Televisional Device
thumbnail: https://thmb.techidaily.com/a7150b4ff2ea7550c12f390526178357d28d5879ccd1eca0b9ed1b9c559e12d9.jpg
---

## Step-by-Step Instructions for Deleting Apps on a Samsung Televisional Device
### What to Know

* 2021-23 models: Press**Home** , then select**Settings** . Highlight the app, scroll down, press**Delete** \>**Delete** .
* 2020 models: Press**Home** , go to**Settings** \>**Support** \>**Device Care** \>**Manage Storage** . Select apps,**Delete** .
* 2017-19 models:**Home** \>**Apps** \>**Settings** \>**Downloaded App** \>**Delete** and follow prompts to confirm.

 This article explains how to delete Samsung TV apps on models made after 2015.

## How to Delete Apps from 2021-2023 Samsung TVs

 Use these directions to erase apps on Samsung TVs made between 2021 and 2023.

1. Press**Home** on the remote if you're not already there. Then, scroll**up** to reach the top bar, and then move to the**right** and select the**Settings/gear** icon.  
![The Settings button highlighted on a Samsung smart TV.](https://www.lifewire.com/thmb/Suw94xo8I9RqBdf-QJYBi-LAtc0=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/A1-DeleteAppsonaSamsungSmartTV-annotated-4785d68910c24ff8a87c0ee61cb72804.jpg)
2. Navigate to the app you're going to remove so it's highlighted.
3. Scroll down and select**Delete** from the pop-up menu.  
![The Delete option highlighted under an app on a Samsung TV.](https://www.lifewire.com/thmb/TzXIy6LC-DSUiuIrOjKC1Kegn30=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/A2-DeleteAppsonaSamsungSmartTV-annotated-804ebd4666054a3ea2bfe4a18235fdf1.jpg)
...
## How to Remove Apps From 2017-2019 Samsung TVs
 ...
 Follow these steps to delete apps on 2017 (M/MU/Q/LS series), 2018 (N/NU/Q/LS series), and 2019 (R/RU/Q/LS series) Samsung TVs:
...
![Samsung Deleted Downloaded App - 2018 Models](https://www.lifewire.com/thmb/FzzVeP8pgW_DAb04-nC4y41lyII=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/004_how-to-delete-apps-on-a-samsung-smart-tv-4589138-8aa24b75d8e540378e567f5ea4748932.jpg)  
 Apps that are pre-installed by Samsung (such as[Netflix](https://www.lifewire.com/overview-of-the-netflix-streaming-service-1847831) ) can't be deleted, but you can remove them from the home screen.

## How to Uninstall Apps on 2015-2016 Samsung TVs

 Follow these steps to delete apps on 2016 (K/KU/KS series) and 2015 (J/JU/JS series) Samsung TVs:
...
![Samsung Delete Screen – Delete Selected App](https://www.lifewire.com/thmb/0UTwkl-7d1xFwKHnphxtWwnBn0I=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/010_how-to-delete-apps-on-a-samsung-smart-tv-4589138-ed8faebd9bb7442c8624b939c1dfb29d.jpg)
...
## How to Hide Apps on the Samsung TV Home Screen
 ...
 There may be variations in the steps depending on your TV's model and year, so consult the user manual if the process below doesn't work.

1. Highlight the app you want to remove from the home screen.
...
* How do I find an app installed on a Samsung TV?  
 Look for it in the**Home** screen menu. If it's not there, go to**Apps** , where all of your TV's apps are listed.
* How do I free up space on my Samsung smart TV?  
 Erase apps you don't use. Reset the Smart Hub. On models made after 2019, also try clearing the app cache and data. If all else fails,[reset your TV](https://www.lifewire.com/reset-samsung-tv-4173258) .
