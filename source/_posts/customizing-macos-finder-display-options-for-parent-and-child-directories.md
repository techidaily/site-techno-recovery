...
excerpt: This Article Describes Customizing MacOS Finder Display Options for Parent and Child Directories
...
## Customizing MacOS Finder Display Options for Parent and Child Directories
### What to Know

* Default view: Open**Finder** \>**View** icon >**View** menu >**Show View Options** \>**Use as Defaults** .
* Folder view: Open folder in Finder >**View** icon >**View** menu >**Show View Options** \>**Always open in X view** .
...
## How to Set the Default Finder View
 ...
 Here's how to set the[Mac Finder](https://www.lifewire.com/use-mac-finder-2260739) view default.
...
![The Use as Defaults button](https://www.lifewire.com/thmb/yhIQnOU2s6Nq7VzJ5v_9gYhgUwE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/003-set-finder-views-for-folders-and-subfolders-2260912-a98dfe067d9a49288d482a42beaf2362.jpg)
...
## How to Permanently Set a Folder View in Finder
 ...
 You've set a system-wide default to using for[Finder windows](https://www.lifewire.com/using-finder-tabs-in-os-x-2259911) , but that doesn't mean you can't assign a different view to specific folders.
...
## How to Automatically Assign a Finder View to All Sub-Folders
 ...
 You can do this quickly using[Automator](https://www.lifewire.com/using-to-automator-rename-files-2260167) , an application Apple includes with macOS to automate workflows, set folder view options for the Pictures folder, and propagate those settings to all of its sub-folders. Here's what to do.
...
<li><a href="https://extra-information.techidaily.com/cutting-edge-videography-top-cameras/"><u>Cutting-Edge Videography Top Cameras</u></a></li>
