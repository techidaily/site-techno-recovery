---
title: "Wireless Connection Mastery: How to Sync Oculus Quest 2 and Mobile Devices"
date: 2024-10-01T12:08:31.472Z
updated: 2024-10-02T02:57:11.874Z
categories:
  - BestProducts
description: "This Article Describes Wireless Connection Mastery: How to Sync Oculus Quest 2 and Mobile Devices"
excerpt: "This Article Describes Wireless Connection Mastery: How to Sync Oculus Quest 2 and Mobile Devices"
thumbnail: https://thmb.techidaily.com/ed7df24877c809d3df195ee4e441348959e5b212ad2e7ace317f9e06a46361d5.jpg
---

## Wireless Connection Mastery: How to Sync Oculus Quest 2 and Mobile Devices
...
* Oculus mobile app:**Menu** \>**Devices** \>**Pair Your Headset** \>**Quest 2** \>**Continue** \> enter pairing code > tap check mark.
* If your Quest 2 won’t pair, try again while wearing the headset and ensure sure your phone is close to the headset.
...
3. Select**Settings** .  
![Settings highlighted in Quest 2 Quick Settings.](https://www.lifewire.com/thmb/xwci80SjT02GP7xIP5S0_WK9LDI=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/A3-PairMetaOculusQuest2toaPhone-annotated-74eccfcb12914158a84ad2a70e6d0415.jpg)
4. Select**System** .  
...
7. If you don’t already have the Meta Quest app, download and install it on your phone.  
...
[  Get the Meta Quest app for Android ](https://play.google.com/store/apps/details?id=com.oculus.twilight&hl=en%5FUS&gl=US)  
[ Get the Meta Quest app for iOS ](https://apps.apple.com/us/app/oculus/id1366478176)
8. Open the app and sign in using your Facebook or Meta account.
9. Tap**Menu** .
10. Tap**Devices** .
11. Tap**Pair New Headset** .  
![Initial steps to pair a phone with an Oculus Quest 2.](https://www.lifewire.com/thmb/6pjIZQeCVszjXlf1XCCKs1XKHPY=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/A11-PairMetaOculusQuest2toaPhone-annotated-b63051f6650345fab82f9d0075377b32.jpg)
12. Tap**Quest 2** .
...
##  How to Pair Quest 2 to iPhone
 ...
 Pairing a Quest 2 to an iPhone works exactly like pairing to an Android.

 The app works and looks the same on both Android and iOS, and the Quest 2 headset doesn’t differentiate between an iPhone and an Android. To pair a Quest 2 to your iPhone, follow the instructions from the previous section.  
...
##  Why Pair a Quest 2 to a Phone?
 ...
 Without having to wear your headset, the app allows you to purchase apps and games, check your friends list, view a gallery of screenshots and videos you’ve taken on the headset, and even view a live stream from the headset.

 The live stream option is beneficial if you want to share your VR experience with someone else.

 If your Quest 2 and phone are paired, you can select the stream option, and your view is mirrored from the headset to your phone screen. That allows a friend to see exactly what you see while you’re playing.

 You can also record gameplay to your phone for easy playback on a computer or share with friends outside the Facebook ecosystem. While the Quest 2 does allow you to share screencaps and clips, it’s limited to[ Facebook](https://www.lifewire.com/what-is-facebook-3486391) and[ Messenger](https://www.lifewire.com/facebook-messenger-4103719) .

 Pairing your Quest 2 to a phone is also necessary if you want to use[ Quest 2 parental controls](https://www.lifewire.com/use-parental-controls-on-quest-6260333) . Your teen's phone must pair to the Quest 2 to initiate a request. You can then accept the request on your phone, which allows you to monitor your child's VR usage, pick which games they’re allowed to play, and adjust other settings.

[ The 8 Best Free VR Games of 2024 ](https://www.lifewire.com/best-free-vr-games-5112949) 

 FAQ

* How do I pair the Meta (Oculus) Quest to a TV?  
 If your TV supports screen-sharing, you can cast your Meta/Oculus Quest headset so other people in the room can see what you see. Use the**Cast** button in the Meta Quest app (it looks like a controller with waves coming out of it), and then select your TV from the list. Your TV, phone, and headset must be on the same Wi-Fi network.
* How do I pair a Meta (Oculus) Quest controller without a phone?  
 Unfortunately, you need the Meta Quest app to pair your controllers with your headset. If the app isn't working, you should[ contact Quest support](https://ocul.us/ContactSupport) to troubleshoot.
