---
title: Step-by-Step Guide to Reboot and Rejuvenate Your Lenovo Device Using Factory Settings
date: 2024-08-26T06:08:54.597Z
updated: 2024-08-27T06:08:54.597Z
categories:
  - BestProducts
description: This Article Describes Step-by-Step Guide to Reboot and Rejuvenate Your Lenovo Device Using Factory Settings
excerpt: This Article Describes Step-by-Step Guide to Reboot and Rejuvenate Your Lenovo Device Using Factory Settings
...
## Step-by-Step Guide to Reboot and Rejuvenate Your Lenovo Device Using Factory Settings
### What to Know

* On Windows 11, go to**Settings** \>**System** \>**Recovery** \>**Reset PC** .
* On Windows 10, go to**Settings** \>**Update & Security** \>**Recovery** \>**Get started** .
* Choose whether to keep your files or delete everything and reinstall Windows.
...
## How to Reset Your Lenovo Laptop While Saving Files
 ...
 If you have a Lenovo IdeaPad or ThinkPad laptop, you may have the option of using the[NOVO button](https://shop-links.co/link/?exclusive=1&publisher_slug=itechdaily19598&url=https%3A%2F%2Fsupport.lenovo.com%2Fus%2Fen%2Fsolutions%2Fht104038) to enter the Lenovo OneKey Recovery mode to factory reset your device.

### Windows 11

 These steps are relevant only for Windows 11:
...
![Next in Reset This PC for Windows 11](https://www.lifewire.com/thmb/G_Ms6LWGBKX5DcNZD8BBKVXEcQE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/007_how-to-factory-reset-a-lenovo-laptop-5115817-8f027ccce52248ecae8156f5181c18db.jpg)  
 Keep your laptop plugged in during this whole process to avoid issues.

### Windows 10

 The Reset This PC process is similar for Windows 10.

1. From the**Start** menu, go to**Settings** \>**Update & Security** .  
...
## How to Perform a Full Reset and Remove Files
 ...
 If you’ll be donating your laptop or you want to fix nagging issues with a clean slate, try a full reset to wipe the machine of everything and sets it to zero.
...
10. If you're donating your laptop or prefer to perform a more detailed reset, choose**Remove everything** \>**Remove files and clean the drive** to delete all apps and custom settings.  
 If you don't see the second option, select**Change settings** and toggle**Data erasure** on.  
![Remove files and clean the drive option from the Reset this PC dialog box on Windows 10](https://www.lifewire.com/thmb/Qv4U6PQP92e1pO-2miSqh7j2ZUY=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/008_how-to-factory-reset-a-lenovo-laptop-5115817-a67348722ce94f9783881ea29e596310.jpg)  
...
<!-- affiliate ads end -->
11. Whichever option you select, choose**Reset** when you’re ready to begin.  
![Reset button to factory reset a PC running on Windows 10](https://www.lifewire.com/thmb/CRV7QDrVLRqtls782wcklz2kJiA=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/009_how-to-factory-reset-a-lenovo-laptop-5115817-3896562db9904194840723693f350502.jpg)

<!-- affiliate ads begin -->
<a href="https://secure.2checkout.com/order/checkout.php?PRODS=3851655&QTY=1&AFFILIATE=108875&CART=1"><img src="http://www.aiseesoft.com/avangate/30p/banner.jpg" border="0"></a>
<!-- affiliate ads end -->
## Should You Reboot or Reset Your Lenovo Laptop?

 Most computer problems can be fixed without a full reset. Reinstalling the entire operating system is a wide fix, but it's not always necessary. You might be better off first trying to[reboot the computer](https://www.lifewire.com/how-to-reboot-a-computer-2624568) . It won't erase anything and is often the first step when troubleshooting PC problems.

 On the other hand, a reset is definitely preferred if you're selling your laptop.

 You can dive deeper into the[differences between rebooting and resetting](https://www.lifewire.com/reboot-vs-reset-4157868) if you're not sure what to do.

[How to Fix It When a Lenovo Laptop Isn't Working](https://www.lifewire.com/fix-when-lenovo-laptop-isnt-working-5119130)
