...
## Elevating Your Workflow: How I Enhanced the Visual Appeal of Windows Terminal
...
###  Installing and Setting Up Oh My Posh
 ...
 To install Oh My Posh, you'll first need the [winget package manager](https://activate-lock.techidaily.com/3-effective-ways-to-bypass-activation-lock-on-iphone-xs-by-drfone-ios/) installed. After that, run this command in CMD to install Oh My Posh:
...
. $PROFILE
 ...
 A little icing on the cake would be using custom icons in addition to custom fonts in the Terminal. [Terminal-Icons](https://github.com/devblackops/Terminal-Icons), a PowerShell module, lets you add cool icons for folders, scripts, and other types of files. First, install the module with this command as administrator:
