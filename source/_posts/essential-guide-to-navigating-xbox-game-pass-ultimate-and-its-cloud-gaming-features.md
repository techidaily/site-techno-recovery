...
excerpt: This Article Describes Essential Guide to Navigating Xbox Game Pass Ultimate and Its Cloud Gaming Features
...
Close 
 ...
 Xbox Cloud Gaming (formerly Project xCloud) is a service you can access if you have an[ Xbox Game Pass Ultimate](https://www.lifewire.com/xbox-game-pass-ultimate-5077716) subscription. It's Microsoft's mobile video game streaming service. Here's everything you could possibly want to know about the streaming platform, including how you can access it.
...
##  How Does Cloud Gaming With Xbox Game Pass Ultimate Work? 
 ...
 All the games on the Xbox Cloud Gaming platform are hosted on remote servers. You stream the games to your device, which means you don't have to own an Xbox system. All you need is a compatible internet-connected device and a data connection fast enough for streaming.

 The Xbox Cloud Gaming platform hosts hundreds of games. You can use Bluetooth or USB-connected controllers.

 If you’re using Xbox Cloud Gaming on an iPhone or iPad, you’ll access the service through Safari and control games with touch controls (where available) or an iOS-compatible controller. For iOS devices, Microsoft recommends two controllers (both are $99):[ Backbone One for iOS](https://www.xbox.com/accessories/mobile-gaming/backbone-one) and[ Razer Kishi Universal Gaming Controller for iOS](https://www.razer.com/mobile-controllers/razer-kishi) .
...
##  How Do I Use Cloud Gaming With Xbox Game Pass Ultimate? 
 ...
 There's also an app for Windows and Android that you can use to play Xbox games remotely. Just sign in with your Game Pass Ultimate credentials to get started.

[ Android ](https://play.google.com/store/apps/details?id=com.gamepass) 

[ Windows ](https://www.xbox.com/apps/xbox-app-for-pc) 
...
##  What Games Are Available? 
 ...
 Xbox Cloud Gaming launched with more than 100 Xbox games. Here are some available titles: _Fortnite, Tom Clancy's Rainbow Six Siege Deluxe Edition, Forza Horizon 5 Standard Edition, Halo Infinite, Sea of Thieves: 2024 Edition, Starfield,_ and_Mortal Kombat 11._ 

 Check out[ the most popular titles on Cloud Gaming](https://www.xbox.com/play/gallery/popular) for other examples.
...
##  Are There Any Downsides to Cloud Gaming With Xbox Game Pass Ultimate? 
 ...
 A strong internet connection is required to stream Xbox games. Microsoft recommends 20 Mbps ([ here's how to do a speed test](https://www.lifewire.com/how-to-test-your-internet-speed-2617987) ) but higher is better when it comes to streaming, especially multiplayer games.

 If you're somewhere with a poor internet connection or you are restricted in how much data you can use each month, a mobile game streaming service might not be a great idea. You may be limited in what you can accomplish, or you could be charged a lot more by your ISP compared to simply buying an Xbox console. 

 There may also be lag issues, as the system depends on your internet connection. In particular, when playing against other players, some slowdown issues might affect playability.

 You can't play Xbox Game Pass games offline. Your device must be connected to the internet at all times. 
...
<li><a href="https://extra-hints.techidaily.com/from-fragmented-footage-to-fluid-editing-inshots-pathway-to-perfection/"><u>From Fragmented Footage to Fluid Editing  Inshot's Pathway to Perfection</u></a></li>
