---
title: "Unveiling the Power of Google's Geminus AI: Mastering Almost Flawless Memory Systems"
date: 2024-10-24T00:21:19.833Z
updated: 2024-10-25T00:53:25.819Z
tags:
  - google
categories:
  - tech
...
## Unveiling the Power of Google's Geminus AI: Mastering Almost Flawless Memory Systems

![gettyimages-1988737599](https://www.zdnet.com/a/img/resize/f1bbf4fbee06be514d767c188234b456d9eaa3b2/2024/08/28/4a48117b-ecdf-4196-a768-8b6c23b72111/gettyimages-1988737599.jpg?auto=webp&width=1280)

NurPhoto/Getty Images

Google is expanding [Gemini 1.5](https://www.zdnet.com/article/what-is-google-gemini/), its most powerful family of AI models, with new variants. 

On Tuesday, [Google AI Studio](https://www.zdnet.com/article/google-makes-gemini-pro-available-in-ai-studio-vertex-ai-tools/) product lead Logan Kilpatrick shared on X that the company had released three new experimental versions of Gemini: a smaller model, Gemini 1.5 Flash-8B; a "stronger" Gemini 1.5 Pro model; and the "significantly improved" Gemini 1.5 Flash.
...
> 
> — Logan Kilpatrick (@OfficialLoganK) [August 27, 2024](https://twitter.com/OfficialLoganK/status/1828480081574142227?ref%5Fsrc=twsrc^tfw)
...
**Also: [Google's Gemini just got two popular ChatGPT Plus features - and one is free to use](https://www.zdnet.com/article/googles-gemini-just-got-two-popular-chatgpt-plus-features-and-one-is-free-to-use/)**
...
Shortly after their release, the latest Gemini 1.5 Pro was ranked #2 and Flash #6 overall in the [Chatbot Arena](https://x.com/lmsysorg/status/1828506835370065994), keeping them essentially neck-and-neck with GPT-4o and [GPT-4o mini](https://www.zdnet.com/article/want-to-try-gpt-4o-mini-3-ways-to-access-the-smarter-cheaper-ai-model-and-2-are-free/), respectively. The two models beat Claude 3.5 Sonnet, Grok 2, Grok 2 mini, and Llama 3.1\. 
...
> \- New Gemini-1.5-Pro (0827) shows strong gains in coding, math over… <https://t.co/6j6EiSyy41> [pic.twitter.com/D3XpU0Xiw2](https://t.co/D3XpU0Xiw2)
> 
> — lmsys.org (@lmsysorg) [August 27, 2024](https://twitter.com/lmsysorg/status/1828506835370065994?ref%5Fsrc=twsrc^tfw)

The experimental models join the Gemini 1.5 family, which is intended to handle very long context windows. In a [technical report](https://arxiv.org/pdf/2403.05530) from earlier this month, the DeepMind team called their capabilities "unprecedented among contemporary large language models (LLMs)," stating that Gemini 1.5 can process multimodal inputs such as "entire collections of documents, multiple hours of video, and almost five days long of audio."
...
Reception of the experimental models, however, has been mixed, with some users [lauding](https://twitter.com/minchoi/status/1828481764848754717) Google's speedy releases while others, [unimpressed](https://twitter.com/Marco%5FPinnisi/status/1828510825574965345), asked for the release of Gemini 2.0 instead. When [asked](https://twitter.com/occamsbulldog/status/1828498247339642935) by one X user about benchmarks, Kilpatrick [replied](https://twitter.com/OfficialLoganK/status/1828498599359238345) that the company plans to launch a version for production use "in the coming weeks, hopefully, that will come with evals!"

Users can test all three models for free in [Google AI Studio](https://t.co/fBrh6UGKz7) and the [Gemini API](https://discuss.ai.google.dev/c/gemini-api/4) today. 
...
<div><ul>
<li><a href="https://fox-friendly.techidaily.com/new-2024-approved-enhancing-zoom-picture-resolution-easy-fixes/"><u>[New] 2024 Approved Enhancing Zoom Picture Resolution Easy Fixes</u></a></li>
...
<li><a href="https://facebook-record-videos.techidaily.com/updated-free-youtube-endings-that-stand-out-ranked/"><u>[Updated] Free YouTube Endings That Stand Out - Ranked</u></a></li>
