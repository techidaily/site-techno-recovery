---
title: Apple Vehicle on the Horizon - Unveiling Price Points, Introduction Date, Tech Specs, and Ongoing Rumors
date: 2025-01-11T17:19:15.406Z
updated: 2025-01-16T18:54:23.529Z
categories:
  - BestProducts
description: This Article Describes Apple Vehicle on the Horizon - Unveiling Price Points, Introduction Date, Tech Specs, and Ongoing Rumors
excerpt: This Article Describes Apple Vehicle on the Horizon - Unveiling Price Points, Introduction Date, Tech Specs, and Ongoing Rumors
thumbnail: https://thmb.techidaily.com/74113c2d83645a48c9d2ad195371cc6a07bee43db8bd23e967a3613c122b6663.jpg
---

## Apple Vehicle on the Horizon - Unveiling Price Points, Introduction Date, Tech Specs, and Ongoing Rumors

 In This Article 

* [ Release Date Estimate ](https://www.lifewire.com/#toc-is-the-apple-car-real)
* [ Price Rumors ](https://www.lifewire.com/#toc-apple-car-price-rumors)
* [ Possible Features ](https://www.lifewire.com/#toc-how-the-apple-car-might-have-worked)
* [ Latest News ](https://www.lifewire.com/#toc-the-latest-news-about-the-apple-car)
...
## Is the Apple Car Real? 
 ...
 In February 2024, however,_Bloomberg's_ Mark Gurman reported that Apple canceled their car project. This was the clearest tip to date that the car was real and might one day be released.

 Then, in May 2024, news broke that[ Apple might partner with electric vehicle firm Rivian](https://www.digitimes.com/news/a20240506PD216/apple-ev-startup-genai.html) . What this means isn't really clear, though, and the information could be bogus or confused for something else like an Apple CarPlay agreement.
...
* In 2015, the New York Times reported that[ Apple contracted Torc Robotics to retrofit two Lexus SUVs with sensors](https://www.nytimes.com/2018/05/23/technology/apple-bmw-mercedes-volkswagen-driverless-cars.html) in a project known internally as Baja.
* In 2016,[ Apple filed a patent for a system explaining to a passenger what the autonomous vehicle is about to do](https://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=1&f=G&l=50&s1=10,053,001.PN.&OS=PN/10,053,001&RS=PN/10,053,001) .
* In 2017,[ Apple was granted permission from the state of California to test self-driving cars](https://twitter.com/kifleswing/status/852914752191967232) , and it was quoted by Bloomberg that the company was "_focusing on autonomous systems_ ."
* In 2018,[ 27 self-driving vehicles were registered with California's DMV](https://www.wired.com/story/ex-apple-employee-accused-of-stealing-self-driving-car-tech/) .
* In 2019, Apple acquired Drive.ai, a technology company that uses AI to make self-driving systems for cars.
* In 2020, the car was reportedly[ set to make its debut in 2021](https://www.techspot.com/news/88051-apple-car-reportedly-make-debut-q3-2021-years.html) , with that source citing suppliers in Taiwan that were planning to scale up production in Q2 2021.
* In 2021, Apple was reportedly in talks with Toyota and Korean partners for the[ production of the Apple car to begin in 2024](https://paultan.org/2021/09/07/apple-car-tech-giant-in-talks-with-toyota-korean-battery-suppliers-for-production-to-commence-2024/) .
* In 2022,[ Apple added 10 drivers to its autonomous vehicle program](https://macreports.com/apple-adds-more-drivers-to-its-autonomous-vehicle-program/) and[ hired a former Lamborghini executive](https://www.macrumors.com/2022/07/27/apple-car-lamborghini-executive-hire/) to lead the design of its electric vehicle.
...
## Apple Car Price Rumors 
 ...
 Some people even considered that[ Apple would set you up with a subscription to use the car](https://wccftech.com/morgan-stanleys-adam-jonas-believes-that-the-fully-autonomous-apple-car-will-only-be-available-as-a-subscription-based-shared-service/) . This would make it more affordable, but you wouldn't own the car.
...
### Self-Driving 
 ...
 A 2023 patent, titled[ Retractable Input Devices](https://image-ppubs.uspto.gov/dirsearch-public/print/downloadPdf/11738795) , explains how the steering wheel and pedals could move away from the driver when they don't need to use them. This suggests that Apple was considering a hybrid style of self-driving that can switch between manual and autonomous mode.[ Opel has this concept video](https://www.youtube.com/watch?v=codJ87lcfPA&t=24s) that shows a similar design.

[ PatentlyApple.com uncovered a patent in 2021](https://www.patentlyapple.com/patently-apple/2021/12/a-series-of-apple-patents-cover-exterior-vehicle-lighting-and-warning-systems-recycling-scrap-aluminum-for-products-more.html) that revealed warning systems that could be built-in to the car, like alerts and exterior text regarding speed, the status of oncoming vehicles, or when it's in self-driving mode. Other information it could show includes upcoming weather, collision risks, nearby traffic jams, etc.

 A[ patent granted in 2022](https://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=1&f=G&l=50&s1=11226625.PN.&OS=PN/11226625&RS=PN/11226625) was for "guidance of autonomous vehicles in destination vicinities using intent signals." In short, it reiterates one of the core ideas behind this car, which is that it would use sensors to understand the surrounding environment to allow navigation with little to no input.

[ Apple was working with a Korean supplier on a centralized OS that controls everything in the car](https://www.patentlyapple.com/2022/04/rumor-apple-is-working-with-a-korean-supplier-on-a-centralized-os-for-apple-car-based-on-a-tesla-like-domain-control-unit.html) . According to that source, the company would adopt "Tesla-type autonomous vehicle architecture. It is a Domain Control Unit (DCU) method that manages several electronic control units (ECU) in an AP that serves as a brain."

 Another patent, titled[ Guidance Of Autonomous Vehicles In Destination Vicinities Using Intent Signals](https://appft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&u=%2Fnetahtml%2FPTO%2Fsearch-adv.html&r=48&p=1&f=G&l=50&d=PG01&S1=%28apple.AANM.+AND+20220505.PD.%29&OS=aanm/apple+and+pd/20220505&RS=%28AANM/apple+AND+PD/20220505%29) , details how a user could control the car's route even in a self-driving situation. Apple introduces one example where a passenger states the following when in the vicinity of a retail store: "I'd like to buy some plants for my garden." The car might then "determine that the vehicle should preferably be parked near an entrance marked 'gardening' or 'gardening supplies'." The patent also suggests another method for how this could work, where a drop-down menu on a screen provides various options, so you're telling the car what to do via a text interface instead of voice commands.

 Self-driving is likely where we're headed with ride-sharing services, and it looks like this was in Apple's roadmap, too. Uncovered by Patently Apple is[ this patent that Apple won regarding an autonomous vehicle-based cab](https://www.patentlyapple.com/2022/10/apple-has-won-a-patent-relating-to-calling-up-and-interacting-with-future-autonomous-vehicle-based-cabs.html) .
...
> For example, the user device is used by the user to initiate a transit request and cause a vehicle to be dispatched to a pick-up location. When the vehicle arrives at the pick-up location, the user device is used by the user to authenticate the vehicle and confirm that the vehicle is the dispatched vehicle for the transit request.  
 ...
 The brains/processor behind the whole system, according to MacRumors, might have been based on the processor used in Apple's other products. A custom Apple silicon chip was reportedly created just for this car that was essentially[ four M2 Ultras merged](https://9to5mac.com/2024/03/11/apple-car-chip-four-m2-ultra/) .
...
Vanarama
 ...
 Although plans for the interior reportedly changed many times over the years, one iteration was for it to[ resemble a private jet or limo](https://www.bloomberg.com/news/newsletters/2024-03-10/what-did-the-apple-car-look-like-inside-apple-s-planned-self-driving-vehicle-ltlic8vt) . Here's Mark Gurman's insight on the company's plans:
...
[ How Much Range You Need in Your EV ](https://www.lifewire.com/how-much-range-you-need-in-your-ev-5202086) 
 ...
 The[ Lucid Air](https://www.lucidmotors.com/air) is one example of a luxury EV that could be comparable to the Apple car, and its claim is up to 520 miles per charge.
 ...
 Apple could have even been developing a brand-new battery design to ensure ample range, according to[ MacRumors](https://www.macrumors.com/) :
...
[ AppleInsider](https://appleinsider.com/) reports Apple was working on some unique safety measures, with the goal being to "spare customers from driving fatigue when they're on long road trips." However this would have taken shape, it's plausible that the iPad-like display could have played a part.
...
### Charging 
 ...
 There's also this[ Modular Charging Systems for Vehicles patent](https://appft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&p=2&u=%2Fnetahtml%2FPTO%2Fsearch-bool.html&r=52&f=G&l=50&co1=AND&d=PG01&s1=%22apple+inc%22.AANM.&OS=AANM/%22apple+inc%22&RS=AANM/%22apple+inc%22) , filed in 2022, which could be used to increase at-home charging speeds.

 Wireless charging for your iPhone and iPad surely would have been included in the car. But what about charging the whole car wirelessly? Some of[ Apple's devices can charge each other](https://www.lifewire.com/apples-end-game-gadgets-that-charge-each-other-5193592) , so would that functionality have come to the Apple car, too?
...
### Other Features 
 ...
 Likewise, the Apple Watch and iPhone would undoubtedly function as keyless tools to unlock the car. Mark Gurman says[ you'd be able to use your iPhone to control and monitor the car](https://twitter.com/markgurman/status/1504933371604045824) ; think speedometer readings, temperature adjustments, radio and seat controls, and triggering the alarm—this is basically confirmed in this[ 2022 Apple patent that details an electronic key](https://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=1&f=G&l=50&s1=11,312,207.PN.&OS=PN/11,312,207&RS=PN/11,312,207) . Facial recognition might have found its way to Apple's vehicle, too, to unlock it or automatically customize the interior to the user who sits down.
 ...
 A[ vehicle-related patent filed by Apple in 2017](https://patents.google.com/patent/US20180089901A1/en) details a VR system that can help address motion sickness for passengers. Here's the abstract:
...
[  These Two Models Give a Glimpse Into the Abandoned Apple Car Designs ](https://9to5mac.com/2024/03/11/apple-car-design/) 

[  Apple Cancels Apple Car Project After More Than a Decade ](https://9to5mac.com/2024/02/27/apple-cancels-apple-car-project-moves-team-to-generative-ai-projects/) 

[  Apple Invents Large In-Vehicle Smart-Table With Multiple Degrees of Freedom ](https://www.patentlyapple.com/2023/05/apple-invents-a-large-in-vehicle-smart-table-with-multiple-degrees-of-freedom-that-could-double-as-a-large-display-and-more.html) 

[  Apple Wins Two Project Titan Patents Relating to Sliding Doors, Unfolding Sunroof Panels & Reinforced Windows ](https://www.patentlyapple.com/2022/09/apple-has-won-two-project-titan-patents-relating-to-sliding-doors-unfolding-sunroof-panels-reinforced-windows.html) 

[  Apple Car to Feature Integrated OS Like Tesla ](https://www.imore.com/report-apple-car-feature-integrated-os-tesla) 

[  Apple Car’s Self-Driving Tech Ran Nearly 13,000 Miles in California in 2021 ](https://www.techtimes.com/articles/271799/20220214/apple-car-self-driving-tech-21-000-km-apple-car-self-driving-california-2021.htm) 
...
<li><a href="https://extra-approaches.techidaily.com/new-reach-new-heights-top-7-applications-turning-your-art-into-nfts/"><u>[New] Reach New Heights Top 7 Applications Turning Your Art Into NFTs</u></a></li>
