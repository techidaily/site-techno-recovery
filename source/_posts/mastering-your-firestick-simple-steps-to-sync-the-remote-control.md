...
excerpt: "This Article Describes Mastering Your Firestick: Simple Steps to Sync the Remote Control"
...
## How to Fix USB Tethering Not Working
 ...
 Before troubleshooting this issue, confirm that you're[using USB tethering correctly on your Windows PC](https://www.lifewire.com/enable-usb-tethering-windows-11-5196403) .

1. [Turn off Wi-Fi](https://www.lifewire.com/when-and-how-to-turn-off-wifi-818302) on your computer. A wireless connection can get in the way of USB tethering, and it takes just a few seconds to see if this is the fix.
2. [Make sure mobile data is working](https://www.lifewire.com/fix-mobile-data-not-working-4769125) . If your hotspot is using your phone's mobile connection, your phone needs to be working properly to serve data to your computer.  
 A quick way to rule this out is to disconnect the phone from the computer and make sure the internet works on the phone. If it doesn't, follow that link to see what could be wrong.
3. Reseat the USB cable. It's as easy as removing and reattaching the cable from your phone and computer. If you have another cable handy, now is a good time to swap it out.
...
[How to Use Your Android Phone as a Wi-Fi Hotspot](https://www.lifewire.com/use-your-android-phone-as-a-portable-wi-fi-hotspot-2377915)
