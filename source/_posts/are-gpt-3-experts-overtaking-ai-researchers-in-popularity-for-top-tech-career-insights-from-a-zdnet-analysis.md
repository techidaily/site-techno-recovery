...
## Are GPT-3 Experts Overtaking AI Researchers in Popularity for Top Tech Career: Insights From a ZDNet Analysis

![man working at computer](https://www.zdnet.com/a/img/resize/2387ea4e38ad9ef7f8ff7048e0930eee62b38b6b/2023/12/18/be93c530-7e8b-484f-9993-a47d3d2961ca/gettyimages-1462638001.jpg?auto=webp&width=1280)

Anchiy/Getty Images

More than a decade ago, in a Harvard Business Review [article](https://hbr.org/2012/10/data-scientist-the-sexiest-job-of-the-21st-century), Thomas Davenport declared data scientist to be the "sexiest job of the 21st century". Today, in an age of [generative artifical intelligence](https://www.zdnet.com/article/what-is-generative-ai-and-why-is-it-so-popular-heres-everything-you-need-to-know/) (AI), is "prompt engineer" about to assume that title?

What's already certain is that it's one of the hottest jobs around. Prompt engineering involves getting the best and most relevant answers from generative AI tools, and is both conversational, "but also programmatic with prompts embedded in code," fellow ZDNET contributor David Gerwitz [explains](https://www.zdnet.com/article/six-skills-you-need-to-become-an-ai-prompt-engineer/). 
...
**Also:** [**How to write better ChatGPT prompts (and this applies to most other text-based AIs, too)**](https://www.zdnet.com/article/how-to-write-better-chatgpt-prompts/)
