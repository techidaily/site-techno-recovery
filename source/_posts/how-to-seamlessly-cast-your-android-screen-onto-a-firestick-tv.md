...
excerpt: This Article Describes How to Seamlessly Cast Your Android Screen Onto a Firestick TV
...
## Troubleshoot When a MacBook Air Freezes
 ...
 There are many different reasons why your MacBook Air may have frozen. If the step doesn't relate to your problem, skip it and move onto the next most relevant one.
...
6. [Boot into Safe Mode](https://www.lifewire.com/how-to-use-mac-safe-boot-option-2260843) . Try using your MacBook Air's Safe Boot mode to check your computer is working correctly and fix any potential ongoing issues.
7. [Free up disc space](https://www.lifewire.com/clear-space-on-your-mac-4165916) . All computers can slow down substantially if they're low on disc space. Try removing unnecessary apps and documents to speed up your MacBook Air and stop it from freezing.
8. [Reset your MacBook Air's PRAM or NVRAM](https://www.lifewire.com/how-to-reset-mac-pram-or-nvram-2260839) . Resetting your MacBook Air's PRAM or NVRAM can solve some basic hardware issues where your system effectively gets confused. It's a simple key combination that can make a huge difference.
9. [Repair permissions](https://www.lifewire.com/using-disk-utility-repair-hard-drives-2260079) . If you're using a MacBook Air running OS X Yosemite or earlier, you may need to repair permissions to ensure any application you have issues with runs correctly. Doing this isn't required since OS X El Capitan as macOS automatically fixes its file permissions, but for older MacBook Airs, it's worth trying.
10. [Reset your MacBook Air.](https://www.lifewire.com/reset-macbook-air-4184823) As a last chance solution, try resetting your MacBook Air by wiping all the information off its hard drive and starting afresh. If you're able to, make sure to have backups of all your important documents, so you don't lose anything valuable.
11. Contact Apple customer support. If you continue to have issues with your MacBook Air freezing, contact Apple customer support. If your laptop is still under warranty, you may be able to get it repaired for free. Failing that, Apple customer support can still advise you on any other repair options and assist you further.

 FAQ

* Why won't my MacBook turn on?  
 If your[Mac won't turn on](https://www.lifewire.com/fix-macbook-pro-that-wont-turn-on-4579948) , it's likely due to a power issue. First, check the power connections and swap out the power cable or adapter if possible. Next, remove all accessories and peripherals from the Mac,[reset the SMC](https://www.lifewire.com/reset-smc-system-management-controller-on-mac-2260840) , then try starting up again.
* How do I restart my MacBook Air?  
 Go to the**Apple** menu > select**Restart** or press and hold**Control** +**Command** +**Power** button/**Eject** button/Touch ID sensor. If that doesn't work,[force restart your MacBook Air](https://www.lifewire.com/restart-macbook-air-5120606) by holding down the**Power** button.
* How do I fix it when my MacBook Air won't start up?  

 If your[Mac won't start up,](https://www.lifewire.com/top-troubleshooting-tips-startup-problems-2259907) disconnect all your Mac's peripherals and try using Safe Boot. Reset the PRAM/VRAM and the SMC if possible, then[run Apple's Disk Utility](https://www.lifewire.com/using-disk-utility-repair-hard-drives-2260079) to repair your hard drive.

* How do I fix the spinning pinwheel of death on my Mac?  
 To[stop the Mac pinwheel of death](https://www.lifewire.com/fix-spod-spinning-pinwheel-of-death-2260811) , force quit the active app and repair the app's permissions. If you're still having problems, clear the Dynamic Link Editor cache and restart your computer. If it's an ongoing problem, consider[upgrading your RAM](https://www.lifewire.com/macs-4781332) .
* How do I fix it when my MacBook's screen isn't working?  
 To[fix problems with your Mac's display](https://www.lifewire.com/troubleshooting-mac-display-problems-4121097) , reset the PRAM/NVRAM and the SMC if possible, then restart your computer. If you're still having issues, use Safe Boot to troubleshoot your graphics software and hardware.
...
<li><a href="https://remote-screen-capture.techidaily.com/updated-in-2024-virtual-journeys-ultimate-listing-of-10-free-mmorpg-games/"><u>[Updated] In 2024, Virtual Journey's  Ultimate Listing of 10 Free MMORPG Games</u></a></li>
<li><a href="https://screen-capture.techidaily.com/updated-mastering-androids-screen-recorder-functions-for-2024/"><u>[Updated] Mastering Android's Screen Recorder Functions for 2024</u></a></li>
...
<li><a href="https://some-guidance.techidaily.com/top-picks-affordable-high-quality-4k-home-theatres-for-2024/"><u>Top Picks  Affordable, High Quality 4K Home Theatres for 2024</u></a></li>
